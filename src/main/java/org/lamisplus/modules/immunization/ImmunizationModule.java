package org.lamisplus.modules.immunization;
...
@Slf4j
@EnableSwagger2
public class ImmunizationModule extends AcrossModule
{
    public final static String NAME = "ImmunizationModule";

    public static void main(String[] args) {
        SpringApplication.run (ImmunizationModule.class, args);
    }

    public ImmunizationModule(){
        super();
